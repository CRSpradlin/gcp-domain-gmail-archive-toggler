        ...
        var extendStatics, __extends = undefined && undefined.__extends || (extendStatics = function(d, b) {
            ...
            function ToggleSwitch(props) {
                ...
                return _this.state = {
                    ...
                    enabled: !0 === _this.props.enabled
                }), _this;
            }
            return __extends(ToggleSwitch, _super), ToggleSwitch.prototype.render = function() {
                var _this = this;
                return react.createElement("div", {
                    className: "toggleBox flex flex-col items-start w-6 rounded-full border border-black",
                    onClick: function() {
                        return _this.onClickHandler();
                    }
                }, react.createElement("div", {
                    className: "togglePin h-3 w-3 rounded-full bg-red-600 " + (this.state.enabled ? "togglePin-enabled" : "togglePin-disabled")
                }));
            }, ToggleSwitch;
            ...
            return root_extends(Root, _super), Root.prototype.render = function() {
                ...
                return react.createElement("div", {
                    ...
                    className: "mt-10"
                }, react.createElement("label", null, "Archive Incoming Messsages: "), react.createElement("input", {
                    name: "archived",
                    checked: "on" == this.state.archivedValue || undefined,
                    onChange: function(e) {
                        return _this.setState({
                            archivedValue: e.target.value
                        });
                    },
                    type: "checkbox"
                })), react.createElement("div", {
                ...
                }))), react.createElement("div", null, react.createElement(ToggleSwitch, {
                    enabled: !1,
                ...
                })), react.createElement("div", null, this.state.emailList.map((function(emailItem) {
                    return react.createElement(react.Fragment, null, react.createElement("h2", null, emailItem[0], ": ", react.createElement("input", {
                        type: "checkbox",
                        disabled: _this.state.loading,
                        checked: 1 == Boolean(emailItem[1]),
                        onClick: function() {
