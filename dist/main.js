 ...
 */
    ...
    (() => {
        ...
        // EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/dist/cjs.js!./src/client/toggleSwitch.css
                var toggleSwitch = __webpack_require__(576), toggleSwitch_options = {};
        ...
        // CONCATENATED MODULE: ./src/client/toggleSwitch.tsx
        var extendStatics, __extends = undefined && undefined.__extends || (extendStatics = function(d, b) {
            ...
            function ToggleSwitch(props) {
                ...
                return _this.state = {
                    ...
                    _this.props.disabled || (_this.props.onChange(!_this.state.toggled), _this.setState({
            ...
            return __extends(ToggleSwitch, _super), ToggleSwitch.prototype.render = function() {
                ...
                return react.createElement("div", {
                    className: "toggleBox flex flex-col items-start h-3.5 w-6 rounded-full border border-teal-950",
                    onClick: function() {
                        return _this.onClickHandler();
                    }
                }, react.createElement("div", {
                    className: "togglePin h-3 w-3 rounded-full " + (this.state.toggled ? "togglePin-toggled bg-teal-400" : "togglePin-untoggled bg-teal-800") + (this.props.disabled ? " !bg-slate-500" : "")
        ...
        }(react.Component), root_extends = undefined && undefined.__extends || function() {
            ...
            function Root(props) {
                ...
                return _this.state = {
                ...
                }, _this.getEmailList = function() {
                    google.script.run.withSuccessHandler(_this.setEmailList).withFailureHandler(_this.handleFailure).GetEmailList();
                }, _this.setEmailList = function(data) {
                    _this.setState({
                        emailList: data,
                        loading: !1
                    });
                    ...
                    e.preventDefault(), _this.setState({
                        loading: !0
                    }), google.script.run.withSuccessHandler(_this.handleFormSuccess).withFailureHandler(_this.handleFailure).SubmitNewEmailForm(document.getElementById("emailForm")), 
                    _this.resetForm();
                }, _this.handleToggleSubmit = function(email) {
                    _this.setState({
                        loading: !0
                    }), google.script.run.withSuccessHandler(_this.handleToggleSuccess).withFailureHandler(_this.handleFailure).ToggleEmail(email);
                }, _this;
            }
            return root_extends(Root, _super), Root.prototype.render = function() {
                var _this = this;
                return react.createElement("div", {
                    className: "h-full flex flex-col content-center items-center text-teal-950"
                    ...
                    className: "text-xl"
                }, "Add New Email")), react.createElement("div", {
                    className: "mt-10"
                }, react.createElement("label", null, "New Email: "), react.createElement("input", {
                    name: "email",
                    ...
                    className: "mt-10 flex flex-row items-center place-itmes-center"
                }, react.createElement("span", null, "Archive Incoming Messsages: "), react.createElement(ToggleSwitch, {
                    disabled: this.state.loading,
                    toggled: this.state.archivedValue,
                    onChange: function(newValue) {
                        return _this.setState({
                            archivedValue: newValue
                        });
                    }
                })), react.createElement("div", {
                    className: "mt-5"
                    ...
                    disabled: this.state.loading,
                    className: "w-[10rem] ".concat(this.state.loading ? "bg-teal-500" : " bg-teal-800 hover:bg-teal-500", " px-5 py-2 text-sm rounded-full font-semibold text-white")
                }))), react.createElement("div", {
                    className: "flex flex-col"
                }, this.state.emailList.map((function(emailItem) {
                    return react.createElement("div", {
                        className: "flex flex-row items-center place-items-center"
                    }, react.createElement("span", null, emailItem[0], ": "), react.createElement(ToggleSwitch, {
                        disabled: _this.state.loading,
                        toggled: Boolean(emailItem[1]),
                        onChange: function() {
                            return _this.handleToggleSubmit(emailItem[0]);
                        }
                    }));
                }))));
            }, Root;
